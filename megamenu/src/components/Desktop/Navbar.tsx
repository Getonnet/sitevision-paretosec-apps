...
const Navbar = () => {
  return (
    <nav role="navigation" className="nav-menu w-nav-menu">
      ...
      <div data-hover="true" data-delay={150} className="dropdown w-dropdown">
        <div className="dropdown-toggle w-dropdown-toggle">
          <div className="drop-arrow-plain w-icon-dropdown-toggle" />
          <div className="dropdown-trigger-text">Børs og marked</div>
        </div>
          ...
          <div className="dropdown-list-full-wrapper">
            <div className="navigation-drop-container">
              <div className="navigation-column">
                <div className="navigation-column-title">
                ...
                <div className="nav-content-wrap">
                  <a href="#" className="navigation-link-block w-inline-block">
      ...
      <div data-hover="true" data-delay={150} className="dropdown w-dropdown">
        <div className="dropdown-toggle w-dropdown-toggle">
          <div className="drop-arrow-plain w-icon-dropdown-toggle" />
          <div className="dropdown-trigger-text">Aktuelt</div>
        </div>
        <nav className="dropdown-list-megamenu w-dropdown-list">
          <div className="dropdown-list-full-wrapper">
            <div className="navigation-drop-container">
      ...
      <div data-hover="true" data-delay={150} className="dropdown w-dropdown">
        <div className="dropdown-toggle w-dropdown-toggle">
          <div className="drop-arrow-plain w-icon-dropdown-toggle" />
          <div className="dropdown-trigger-text">Om oss</div>
        </div>
      ...
      <div data-delay={150} data-hover="true" className="dropdown w-dropdown">
        <div className="dropdown-toggle w-dropdown-toggle">
          <div className="drop-arrow-plain w-icon-dropdown-toggle" />
          <div className="dropdown-trigger-text">Kundeservice</div>
        </div>
        <nav className="dropdown-list-megamenu w-dropdown-list">
          <div className="dropdown-list-full-wrapper">
            <div className="navigation-drop-container">
