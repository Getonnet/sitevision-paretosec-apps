...
var _ResourceLocatorUtil = _interopRequireDefault(require("@sitevision/api/server/ResourceLocatorUtil"));
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } // import router from "@sitevision/api/common/router";
...
(function () {
  ...
  router.post("/add-redirect-uris", function (req, res) {
    var urlArr = getFormattedValues(req.params.value);
    function addRedirectsWithDelay(_x) {
      return _addRedirectsWithDelay.apply(this, arguments);
    }
    function _addRedirectsWithDelay() {
      _addRedirectsWithDelay = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(urlArr) {
        var i, url, targetNode;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 1:
              ...
              url = urlArr[i];
              targetNode = resourceLocatorUtil.getNodeByUrl(url[1]);
              if (!targetNode) {
                _context.next = 8;
                break;
              }
